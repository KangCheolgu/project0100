...
Command: npx gltfjsx@6.2.16 public\assets\models\resort-trees_ref.glb -o src/components/resort-trees_ref.jsx -r public 
*/

import React, { useRef } from 'react'
import { useGLTF } from '@react-three/drei'

export function Resort_trees_ref(props) {
  const { nodes, materials } = useGLTF('/assets/models/resort-trees_ref.glb')
  return (
...
useGLTF.preload('/assets/models/resort-trees_ref.glb')
