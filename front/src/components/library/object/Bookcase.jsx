...
Command: npx gltfjsx@6.2.16 public\assets\models\Bookcase.glb -o src/components/library/object/Bookcase.jsx -r public 
*/
...
export function Bookcase(props) {
  const { nodes, materials } = useGLTF('/assets/models/Bookcase.glb')
  return (
...
useGLTF.preload('/assets/models/Bookcase.glb')
