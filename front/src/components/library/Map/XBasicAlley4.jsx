...
export default function XBasicAlley4(props){
    ...
    return(<group {...props}>
        <ColliderBox scale={[scale[0]+4,scale[1]+0.58, scale[2]+4]} position={[position[0],position[1]+2, position[2]+1.7]} rotation ={[rotation[2]-Math.PI/2, rotation[0], rotation[1]]}></ColliderBox>
        <Wall position= {[0, 0, 1.9]}/>
        ...
        <ColliderBox scale={[scale[0]+4,scale[1]+0.58, scale[2]+4]} position={[position[0],position[1]+2, position[2]-2.1]} rotation ={[rotation[2]-Math.PI/2, rotation[0], rotation[1]]}></ColliderBox>
        <Wall position= {[0, 0, -1.9]}/>
