...
export default function YBasicAlley4(props){
    ...
    return(<group {...props}>
        <ColliderBox scale={[scale[0]+4.2,scale[1]+0.58, scale[2]+4]} position={[position[0]-2,position[1]+2, position[2]]} rotation ={[rotation[2], rotation[0], rotation[1]-Math.PI/2]}></ColliderBox>
        <Wall position= {[-1.9, 0, 0]} rotation ={[0, 0, Math.PI/2]}/>
