...
export function CarModel( props ) {
  ...
  // useEffect(() => {
  //   const brakeLightColor = brakeLightsOn ? new Color(1, 0, 0) : new Color(0, 0, 0);
  //   if (materials['red-l'] && materials['red-r']) {
  //     materials['red-l'].emissive = brakeLightColor;
  //     materials['red-r'].emissive = brakeLightColor;
  //   }
