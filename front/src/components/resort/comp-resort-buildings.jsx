...
Command: npx gltfjsx@6.2.16 public\assets\models\comp-resort-buildings.glb -o src/components/comp-resort-buildings.jsx -r public -s 
*/
...
export function Buildings(props) {
  const { nodes, materials } = useGLTF('/assets/models/comp-resort-buildings.glb')
  return (
...
useGLTF.preload('/assets/models/comp-resort-buildings.glb')
