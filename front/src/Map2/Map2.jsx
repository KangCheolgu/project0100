...
export default function Map2(props){
    ...
    return(<group receiveShadow >
        ...
        <Road_half_3 position={[position[0]+18, position[1]+0.009, position[2]-6]} rotation={[0, Math.PI/2, 0]}/>
        ...
        <Road_4 position={[position[0]+24, position[1]+0.009, position[2]]}/>
        ...
        <Road_half_3 position={[position[0]+24, position[1]+0.009, position[2]-30]} rotation={[0, 0, 0]}/> 
        ...
        <Road_half_3 position={[position[0]+6, position[1]+0.009, position[2]-27]} rotation={[0, -Math.PI/2, 0]}/>
        <Road_half_3 position={[position[0]+18, position[1]+0.009, position[2]-27]} rotation={[0, Math.PI, 0]}/>
        ...
        <Road_half_3 position={[position[0]+30, position[1]+0.009, position[2]-6]} rotation={[0, 0, 0]}/>
        ...
        <Road_half_3 position={[position[0]+48, position[1]+0.009, position[2]-24]} rotation={[0, -Math.PI/2, 0]}/>
        <Sidewalk_corner_7 position={[position[0]+51, position[1]+0.09, position[2]-21]} rotation={[0, 0 ,0]}/>
        <Road_half_3 position={[position[0]+54, position[1]+0.009, position[2]-24]} rotation={[0, Math.PI, 0]}/>
