...
import {Grass, Road_1, Road_4, Road_3, Sidewalk_2, Sidewalk, Sidewalk_half, Road_half_3, Sidewalk_corner_3, Sidewalk_corner_7, } from "./components/resort/Road.jsx"
...
export default function Map1(props){
    ...
    return(<group castShadow receiveShadow >
        ...
        <Sidewalk_2 position={[position[0]+13.5, position[1]+0.01, position[2]+10.5]} rotation={[0, 0, 0]}/>

        <Sidewalk_half position={[position[0]+15, position[1]+0.01, position[2]+7.5]}/>
        <Sidewalk position={[position[0]+18, position[1]+0.01, position[2]+7.5]}/>
